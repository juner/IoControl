...
namespace IoControl.Controller
{
    ...
    internal readonly struct AtaPassThroughExWithMiniBuffer : IAtaPassThroughEx<Buffer5>
    {
        ...
        public AtaPassThroughExWithMiniBuffer(AtaFlags AtaFlags = default, byte PathId = default, byte TargetId = default, byte Lun = default, byte ReservedAsUchar = default, uint TimeOutValue = default, uint ReservedAsUlong = default, ushort Feature = default, ushort SectorCouont = default, ushort SectorNumber = default, uint Cylinder = default, byte DeviceHead = default, byte Command = default, ushort Reserved = default, byte[] Buffer = default)
            : this(AtaFlags, PathId, TargetId, Lun, ReservedAsUchar, TimeOutValue, ReservedAsUlong, new TaskFile(AtaFlags, Feature, SectorCouont, SectorNumber, Cylinder, DeviceHead, Command, Reserved), Buffer) { }
        public AtaPassThroughExWithMiniBuffer(AtaFlags AtaFlags = default, byte PathId = default, byte TargetId = default, byte Lun = default, byte ReservedAsUchar = default, uint TimeOutValue = default, uint ReservedAsUlong = default, ushort Feature = default, ushort SectorCouont = default, ulong Lba = default, byte DeviceHead = default, byte Command = default, ushort Reserved = default, byte[] Buffer = default)
            : this(AtaFlags, PathId, TargetId, Lun, ReservedAsUchar, TimeOutValue, ReservedAsUlong, new TaskFile(AtaFlags, Feature, SectorCouont, Lba, DeviceHead, Command, Reserved), Buffer) { }
     ...
     internal readonly struct AtaPassThroughEx32WithMiniBuffer : IAtaPassThroughEx<Buffer5>
    {
        ...
        public AtaPassThroughEx32WithMiniBuffer(AtaFlags AtaFlags = default, byte PathId = default, byte TargetId = default, byte Lun = default, byte ReservedAsUchar = default, uint TimeOutValue = default, uint ReservedAsUlong = default, ushort Feature = default, ushort SectorCouont = default, ushort SectorNumber = default, uint Cylinder = default, byte DeviceHead = default, byte Command = default, ushort Reserved = default, byte[] Buffer = default)
            : this(AtaFlags, PathId, TargetId, Lun, ReservedAsUchar, TimeOutValue, ReservedAsUlong, new TaskFile(AtaFlags, Feature, SectorCouont, SectorNumber, Cylinder, DeviceHead, Command, Reserved), Buffer) { }
        public AtaPassThroughEx32WithMiniBuffer(AtaFlags AtaFlags = default, byte PathId = default, byte TargetId = default, byte Lun = default, byte ReservedAsUchar = default, uint TimeOutValue = default, uint ReservedAsUlong = default, ushort Feature = default, ushort SectorCouont = default, ulong Lba = default, byte DeviceHead = default, byte Command = default, ushort Reserved = default, byte[] Buffer = default)
            : this(AtaFlags, PathId, TargetId, Lun, ReservedAsUchar, TimeOutValue, ReservedAsUlong, new TaskFile(AtaFlags, Feature, SectorCouont, Lba, DeviceHead, Command, Reserved), Buffer) { }
        public override string ToString()
